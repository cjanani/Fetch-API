...
function display(obj)
{
    ...
    // titleLink.href = `'http://google.com/search?q='+${obj.title}`;
    // titleLink.target = "blank";
    // divq.appendChild(titleLink);
